-- =============================================================================
-- Lightup — DuckDB Demo Data Setup
-- =============================================================================
-- This file is executed automatically by `uv run prelight setup-demo` when the
-- duckdb backend is configured, or by `python setup/duckdb/init_local.py`.
--
-- It creates the schema, tables, and sample data needed for the end-to-end demo.
-- Safe to run multiple times — tables are dropped and recreated each time.
-- =============================================================================
